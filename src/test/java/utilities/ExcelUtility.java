...
public class ExcelUtility {
	...
	private void setCellData(String sheetName,int rowNum,int column,String data) throws IOException {
		...
		if(workbook.getSheetIndex(sheetName)==-1) {  //if any sheet not present
			workbook.createSheet(sheetName);
				
		}
		sheet=workbook.getSheet(sheetName);
				
		if(sheet.getRow(rowNum)==null) {  //if rows does not exits
